...
/*   Updated: 2023/01/30 18:59:39 by siwolee          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				sort_merge(t_stack *s, unsigned int start, \
					unsigned int end, char ab);
t_pivot				*new_pivot(t_stack *s, unsigned int start, \
					unsigned int end);
